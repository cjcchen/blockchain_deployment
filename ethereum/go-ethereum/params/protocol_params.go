...
var (
	...
	//GenesisDifficulty      = big.NewInt(524288*4) // Difficulty of the Genesis block.
	GenesisDifficulty      = big.NewInt(131072) // Difficulty of the Genesis block.
	//MinimumDifficulty      = big.NewInt(524288*4) // The minimum that the difficulty may ever be.
