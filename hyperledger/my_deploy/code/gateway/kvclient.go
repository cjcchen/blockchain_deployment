...
const (
	mspID         = "Org1MSP"
	cryptoPath    = "../../User1@org1.example.com/"
	certPath      = cryptoPath+"msp/signcerts/User1@org1.example.com-cert.pem"
	keyPath       = cryptoPath+ "msp/keystore"
	tlsCertPath   = "../../peer0.org1.example.com/tls/ca.crt"
...
func getAllAssets(contract *client.Contract) {
	...
	evaluateResult, err := contract.EvaluateTransaction("GetAllData")
	if err != nil {
